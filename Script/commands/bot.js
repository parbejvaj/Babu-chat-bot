...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Babu") || (event.body.toLowerCase() == "বাবু") || (event.body.toLowerCase() == "@বা্ঁবু্ঁ আ্ঁসো্ঁ") || (event.body.toLowerCase() == "Rana")) {
   ...
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "tumar ke ")) {
  ...
  if ((event.body.toLowerCase() == "Farhana") || (event.body.toLowerCase() == "Rimi")) {
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "হাবিব ")) {
