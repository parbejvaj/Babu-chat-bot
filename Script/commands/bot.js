...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "/hek") || (event.body.toLowerCase() == "/hek")) {
  ...
  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("ami rana❤️ তাকে সবাই বাবু নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@─RITU BORNA➺🪼🪻🩷🪽󱢏") || (event.body.toLowerCase() == "@─RITU BORNA➺🪼🪻🩷🪽󱢏 ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস রানা এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "rimi") || (event.body.toLowerCase() == "Rimi")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রানা এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "pakhi") || (event.body.toLowerCase() == "@ম্ঁন্ঁ পা্ঁখি্ঁ ম্ঁন্ঁ পা্ঁখি্ঁ")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রানা এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "nila") || (event.body.toLowerCase() == "@আ্ঁমি্ঁ কা্ঁর্ঁ প্রো্ঁপা্ঁটি্ঁ")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রানা এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@Editing Znx") || (event.body.toLowerCase() == "@Editing Znx")) {
     return api.sendMessage("🥰-হাবিব🌺 আমার বস রানা'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক শালা বিবাহিত 😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
     return api.sendMessage("️ এইদিকে ওইদিকে কি দেখো জানু আমার বস রানা কে দেখো😘", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "আমাকে কেউ ভালোবাসে না") || (event.body.toLowerCase() == "amake kew valobase na") || (event.body.toLowerCase() == "Aj kew nai bole")) {
     return api.sendMessage("️চিন্তা করো কেন আমার বস রানা তো আছে🫶/nতোমাকে রাইতে ভালোবাসবো😁💦", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে বাবুর ইনবক্সে চলে যা পাগল ছাগল🌚🐸🌶️🍆", threadID);
   };

   if ((event.body.toLowerCase() == "কেমন আছো") || (event.body.toLowerCase() == "কেমন আছেন") || (event.body.toLowerCase() == "Kmon acho") || (event.body.toLowerCase() == "bot kemon aso") || (event.body.toLowerCase() == "তুমি কেমন আছো")) {
   ...
   if ((event.body.toLowerCase() == "বট তুমি কি আমাকে ভালোবাস ") || (event.body.toLowerCase() == "tmi ki amake vlo basho")) {
